...
if (/^اينوسكي$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, "عيونه ❤️`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}
 ...
     conn.reply(m.chat, ``, m) //wm, null, [['Menu', '#menu']], m) botones :V 
    ...
    if (/^سوكونا2$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `ملك اللعنات❤️‍🔥🐦`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
     conn.reply(m.chat, `اوهايو كوزيماس `, m) //wm, null, [['Menu', '#menu']], m) botones :V
   ...
   if (/^ايانو||مايكي|سابو|هيما$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat,'صديق ايتاتشي الروح بروح 😂❤', m) //wm, null, [['Menu', '#menu']], m) botones :V
